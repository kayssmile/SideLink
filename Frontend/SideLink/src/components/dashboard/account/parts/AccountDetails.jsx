          ...
          <CardContent component="form" onSubmit={handleSubmit(onSubmit)}>
            ...
            {confirmModal && (
              <Modal
                ...
                modalContent={
                  accountDetails.error ? getAccountErrorMessage(accountDetails.error) : accountDetails.success ? <Typography color="success">Account erfolgreich aktualisiert!</Typography> : ''
                }
